...
![Launch CloudFormation](/images/2.2-LaunchCloudFormation/1.9.png?width=90pc)
...
3. Thực hiện cấu hình stack:
   ...
   - Ở **Availability Zones**, chọn **us-east-2a và us-east-2b**.
...
9. Cuối cùng chọn  **Submit** của stack vừa được tạo.
![Launch CloudFormation](/images/2.2-LaunchCloudFormation/11.png?width=91pc)

10. Template mất khoảng 15 phút để hoàn thành. Trong thời gian này, chúng ta sẽ xem xét những thành phần mà template CloudFormation sẽ tạo. Sau khi quá trình khởi tạo stack hoàn tất, trạng thái của stack sẽ chuyển thành **CREATE_COMPLETE**.

![Launch CloudFormation](/images/2.2-LaunchCloudFormation/12.png?width=91pc)
11. Xem phần **Output** của stack vừa được tạo.
